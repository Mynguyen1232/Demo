			...
			<div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item dropdown dropdown-mega position-static"><a
						...
						data-bs-toggle="dropdown" aria-expanded="false">Sofas</a>
										...
										<div class="col-lg-3 col-sm-6 py px-xl-5 px-4">
											<div class="list-group">
												<a href="" class="list-group-item"
													style="font-weight: bold;">Chairs</a> <a href=""
													class="list-group-item">Stonewave</a> <a href=""
					...
					<li class="nav-item"><a class="nav-link"
						href="listProduct.html">Chests</a></li>
					<li class="nav-item"><a class="nav-link" href="#">Artian</a></li>
					<li class="nav-item dropdown"><a href="#"
						class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
						aria-expanded="false"> More</a>
						<ul class="dropdown-menu">
							<li><a href="#" class="dropdown-item">Sewing</a></li>
							<li><a href="#" class="dropdown-item">Crochet</a></li>
							<li><a href="login.html" class="dropdown-item">Login</a></li>
							<li><a href="#" class="dropdown-item">Extend
									Descriptions</a></li>
						</ul></li>
				</ul>
			</div>
			<ul>
				<a href="" class="icon-link" style="text-decoration: none;"><i
					class="bi bi-cart3 fs-3"></i></a>
			</ul>
		</div>
	</nav>
</header>